...
[![Normal Difficulty](https://gladiatusfansite.blob.core.windows.net/images/Underworld/Normal-Button.png "Normal Difficulty")](/underworld/underworld-normal "Normal") [![Medium Difficulty](https://gladiatusfansite.blob.core.windows.net/images/Underworld/Medium-button.png "Medium Difficulty")](/underworld/underworld-medium "Medium") [![Hard Difficulty](https://gladiatusfansite.blob.core.windows.net/images/Underworld/Hard-button.png "Hard Difficulty")](/underworld/underworld-hard "Hard")
...
- Entering the Underworld you are using **another set of Expedition points - 18x ![Expedition point](https://gladiatusfansite.blob.core.windows.net/images/Startup_guide/Expedition_point.png "Expedition point")**. The normal Expedition and Dungeon points outside of the Underworld are not consumed. If you run out of the 18 Underworld expedition points, **every attack starts to cost 1** ![Rubies](https://gladiatusfansite.blob.core.windows.net/images/icon_rubies.gif "Rubies") . This means that **you can have 2 defeats tops** if you want to finish Ruby-free/boost free. Also, it's good to know that [Blessing's of Apollo](/game-guide/premium/pacts#blessing-from-apollo "Blessing's of Apollo") pact's ​"You have 10% chance of not using up any expedition points." works in the Underworld. The 10% expedition points increase however, doesn't work.
- There is one way to top up your Underworld expedition points - Mobilisation, which drops from [Divine Chest of Faith](/game-guide/pantheon/treasury "Divine Chest of Faith")
...
![Slide 1](https://gladiatusfansite.blob.core.windows.net/images/Underworld/slide1.png "Slide 1") ![Slide 2](https://gladiatusfansite.blob.core.windows.net/images/Underworld/slide2.png "Slide 2") ![Slide 3](https://gladiatusfansite.blob.core.windows.net/images/Underworld/slide3.png "Slide 3")
...
https://www.youtube.com/watch?v=8uyNS_HrDbE
...
- If you want to leave the Underworld on your own will, when entering Underworld Ceres would give you as a package 1x Golden Branch ![Golden Branch](https://gladiatusfansite.blob.core.windows.net/images/Items/img/Misc/Golden_Branch.png "Golden Branch"). If you want to leave, put the Branch in your inventory, go to Leave the Underworld button and drag the branch onto the exit gate, shown below. This will make you leave underworld on your own will
