...
- First two smelting slots cost ![Gold](https://gladiatusfansite.blob.core.windows.net/images/icon_gold.gif "Gold") and the other 4 ![Rubies](https://gladiatusfansite.blob.core.windows.net/images/icon_rubies.gif "Rubies"). Cost depends on the item level and type of the item being smelted
...
- If you are farming for repair materials and you don't care about quality - you best search Auction house for a [prefix](prefixes "prefixes") which you know will smelt into the material you are looking for and try to choose item slots like gloves, helmets and boots who have shorter smelting time
...
We can see that ![Copper](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Copper.png "Copper") and the ![Scroll](https://gladiatusfansite.blob.core.windows.net/images/Items/img/Scrolls/Bejav_Scroll.png "Scroll") did not come out of the smelt at all. Total materials from the smelt: 36

The rest of the materials came in different low quantities and both ![Amethyst](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Amethyst.png "Amethyst") and ![Obsidian](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Obsidian.png "Obsidian") came in two colors - **Orange** and **Purple**. No **Red** materials this time. Some materials came only in **Orange** and some only in **Purple**
...
Good smelt. Two **Red** materials. Both ![Sapphire](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Sapphire.png "Sapphire") and ![Obsidian](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Obsidian.png "Obsidian") produce all 3 colors. Total materials from the smelt: 30
