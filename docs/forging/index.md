...
The Forging system is the ability to collect forging goods either by smelting gear or drops from your adventures to ultimately forge an item of your choosing by selecting the prefix and the suffix and to determine what the item quality will be based on the used forging goods. With this came the durability and conditioning of items. More about this below.
...
[Learn more about Forging Goods →](/forging/forging-goods)

---

### Forging

Using the forging goods and the required recipe you can forge items of your choosing. Click on the image below for extensive info.

[![Forging](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forge/forging.png "Forging")](forging-2 "Forging")

[Learn more about Forging →](/forging/forging-2)
...
[![Smelting](https://gladiatusfansite.blob.core.windows.net/images/Forging/Smelting/smelting.png "Smelting")](smelting "Smelting")

[Learn more about Smelting →](/forging/smelting)
...
[![Workbench](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/workbench.png "Workbench")](workbench "Item Repair and Conditioning")

[Learn more about Item Repair and Conditioning →](workbench)
...
[![Malefica](https://gladiatusfansite.blob.core.windows.net/images/Forging/Tools/Malefica.png "Malefica")](forging-tools "Forging Tools")

[Learn more about Forging Tools →](/forging/forging-tools)

---

### Scrolls and Recipes

Prefixes and Suffixes for crafting items.

[![Scrolls Prefixes and Suffixes](https://gladiatusfansite.blob.core.windows.net/images/Forging/Scrolls_Overview.png "Scrolls Prefixes and Suffixes")](scrolls-recipes "Scrolls and Recipes")

[Learn more about Scrolls and Recipes →](scrolls-recipes)

---

### Horreum

Horreum is the new storage for forging goods so they don't take bag space. Also has the ability to upgrade quality.

[![Horreum](https://gladiatusfansite.blob.core.windows.net/images/Forging/Horreum/Horreum_button.png "Horreum")](horreum "Horreum")

[Learn more about Horreum →](horreum)