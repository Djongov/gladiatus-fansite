---
title: Gladiatus Item Repair and Conditioning
sidebar_label: Item Repair and Conditioning
slug: /forging/conditioning-workbench
---
...
![Gladiatus Workbench](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/workbench.png "Gladiatus Workbench")
...
![Losing durability](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/Losing_durability.png "Losing durability")
...
![Workbench](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/Workbench_interface.png "Workbench")
...
![Repairing](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/Repairing.png "Repairing")
...
Just click on the button: ![Work on](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/work_button.png "Work on")
...
![Repair example](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/repair_example.png "Repair example")

Let's insert 1× ![Scorpion Poison](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Scorpion_Poison.png "Scorpion Poison") **Blue** quality:

![Repairing](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/Repairing.png "Repairing")

It will repair exactly 9,966 as calculated. Let's use 1× ![Leather](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Leather.png "Leather") **Purple** quality now:

![Repair example](https://gladiatusfansite.blob.core.windows.net/images/Forging/Conditioning/repair_example2.png "Repair example")

The 1× ![Leather](https://gladiatusfansite.blob.core.windows.net/images/Forging/Forging_goods/Leather.png "Leather") added another 9,966 exactly for the total of 19,932. This teaches us 2 valuable lessons:

1. **It doesn't matter what material you put in**—whether it's Bull's Horn, Leather, or Scorpion Poison, they all equal the same amount of repair points
2. **Higher quality materials do NOT provide more repair points**
...
- You can repair up to **2 items** at the same time for ![Gold](https://gladiatusfansite.blob.core.windows.net/images/icon_gold.gif "Gold"). If you want more, you can use the other 4 paid workbench slots, but they cost ![Rubies](https://gladiatusfansite.blob.core.windows.net/images/icon_rubies.gif "Rubies")
...
- When a repair is finished, the item will be sent as a package
...
- Certain Micro Events or Dis Pater costumes remove any durability loss

- **Pro Tip:** Because it doesn't matter what quality of material you use to repair your item—save your Purple/Orange/Red materials for forging and repair using Green/Blue ones. On high levels, even Purple materials are fine for repairing as you are aiming for Orange and Red items only