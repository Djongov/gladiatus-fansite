---
title: Scrolls and Recipes
slug: /scrolls-recipes/scrolls-and-recipes
---
...
Here is an example how Lucius Scroll drops from Dragon, the boss in [Koman Mountain](germania-expeditions#KomanMountain "Koman Mountain").

![Lucius scroll drop](https://gladiatusfansite.blob.core.windows.net/images/Forging/Lucius_scroll_drop.png "Lucius scroll drop")

Here is an example how a scroll with a prefix or suffix can drop from [Smelting](Smelting "Smelting") too. However the drop chance is low - about 5%.
