...
Minions item level drop: **9-10** `✓` Verified
...
![Gustavos Country House](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/Gustavos_Country_House.png "Gustavos Country House")
...
<div className="player_name_bg">
  <div className="playername">Lunatic Ripper</div>
</div>
![Lunatic Ripper!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/Lunatic_Ripper.jpg)

![Lunatic Ripper Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/Lunatic_Ripper_stats.jpg)
...
![The right way!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/2nd-step.JPG)

Fight the Wild Pigs. They can be 2, 3 or 4

<div className="player_name_bg">
  <div className="playername">Wild Pig</div>
</div>
![Wild Pig!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/Wild_Pig.jpg)

![Wild Pig Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/Wild_Pig_stats.jpg)

---

 Just like the Medusa, the 3/3 XXX are also optional. You can face the boss directly. He is:

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Gustavos_Country_House/boss-step.JPG "Boss")

## King Gustavo

<div className="player_name_bg">
  <div className="playername">King Gustavo</div>
</div>
