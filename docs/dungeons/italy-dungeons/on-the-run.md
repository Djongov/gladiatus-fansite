...
![On the Run](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/On_the_Run.png "On the Run")
...
![Gnaeus` Follower!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Gnaeus_Follower.jpg)

![Gnaeus` Follower Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Gnaeus_Follower_stats.png)

Once all 6 Followers are defeated you will proceed to the next step

![Step 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Step1.png "Step 1 Completed")

---

Now a lot more enemies appear

![On the Run Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/On_the_Run_phase2.png "On the Run Phase 2")

You don't have to kill all of them. Go for the 6/6 Suspicious Fishermen

![Suspicious Fisheman](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Suspicious_Fisherman_overview.png "Suspicious Fisheman Overview")
...
![Suspicious Fisherman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Suspicious_Fisherman.jpg)

![Suspicious Fisherman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Suspicious_Fisherman_stats.png)
...
![Step 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Step2.png "Step 2 Completed")

---

Now that you have caught up to the Senator and his 2 bodyguards, start attacking them.

![On the Run Phase 3](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/On_the_Run_phase3.png "On the Run Phase 3")

## Gnaeus` Bodyguards

<div className="player_name_bg">
  <div className="playername">Gnaeus` Bodyguards</div>
</div>
![Gnaeus` Bodyguards!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Gnaeus_Bodyguards.jpg)

![Gnaeus` Bodyguards Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Gnaeus_Bodyguards_stats.png)

After killing the two bodyguards you are left alone with the Senator

![Step 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/Step3.png "Step 3 Completed")

---

You can now strike the boss. Who is he?

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/On_the_Run/On_the_Run_phase4.png "On the Run Phase 4")
