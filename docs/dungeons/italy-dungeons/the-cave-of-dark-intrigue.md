...
![The Cave of Dark intrigue](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/The_Cave_of_Dark_intrigue.png "The Cave of Dark intrigue")
...
<div className="player_name_bg">
  <div className="playername">Wolf</div>
</div>
![Wolf!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Wolf.jpg)

![Wolf Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Wolf_stats.png)

Once you defeat all 3 wolves you will complete Quest 1

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Quest1_Completed.png "Quest 1 Completed")

---

Then you fight a dwarf for the key

![Phase 1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/The_Cave_of_Dark_intrigue_phase1.png "Phase 1")

## Hell Dwarf

<div className="player_name_bg">
  <div className="playername">Hell Dwarf</div>
</div>
![Hell Dwarf!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Hell_Dwarf.jpg)

![Hell Dwarf Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Hell_Dwarf_stats.png)

You also complete the second quest

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Quest2_Completed.png "Quest 2 Completed")

---

You go and search for the other key

![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/The_Cave_of_Dark_intrigue_phase2.png "Phase 2")

## Nasty Journeyman

<div className="player_name_bg">
  <div className="playername">Nasty Journeyman</div>
</div>
![Nasty Journeyman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Nasty_Journeyman.jpg)

![Nasty Journeyman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Nasty_Journeyman_stats.png)

You also complete the final quest

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/Quest3_Completed.png "Quest 3 Completed")

---

You can now unlock the gates and enter the last cave where the huge hound is

![Phase 3](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Cave_of_Dark_intrigue/The_Cave_of_Dark_intrigue_phase3.png "Phase 3")
...
<div className="player_name_bg">
  <div className="playername">Hell Dog</div>
</div>
