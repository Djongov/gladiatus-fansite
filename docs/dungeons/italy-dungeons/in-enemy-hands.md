...
![Phase 1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Phase1.png "Phase 1")
...
![Gate Guards!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Gate_Guards.jpg)

![Gate Guards Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Gate_Guards_stats.png)

Once you take out the two of them you complete the first quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Quest1.png "Quest 1 Completed")
...
![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Phase2.png "Phase 2")
...
![Patrol!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Patrol.jpg)

![Patrol Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Patrol_stats.png)

Looks like the 2nd patrol was having keys to the towers on their chain. You pick them up

![Quest 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Quest2.png "Quest 2")
...
![Phase 3](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Phase3.png "Phase 3")
...
![Medusa!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Medusa.jpg)

![Medusa Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Medusa_stats.png)

The first one down...

![One Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/One_Down.png "One Down")

The second one is down too...

![Two Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Two_Down.png "Two Down")

Third one down...

![Three Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/three_Down.png "Three Down")

and finally the last one is down as well....

![Four Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Four_Down.png "Four Down")

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Quest3.png "Quest 3 Completed")
...
![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Phase4.png "Boss")

## Trakovar

<div className="player_name_bg">
  <div className="playername">Trakovar</div>
</div>
![Trakovar!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Trakovar.jpg)

![Trakovar Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/In_enemy_hands/Trakovar_stats.png)
