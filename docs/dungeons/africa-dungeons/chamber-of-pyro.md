...
![Chamber of Pyro](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Chamber_of_Pyro.png "Chamber of Pyro")
...
![Phase 1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Phase1.png "Phase 1")

## Pantinus Imperator

<div className="player_name_bg">
  <div className="playername">Pantinus Imperator</div>
</div>
![Pantinus Imperator!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Pantinus_Imperator.jpg)

![Pantinus Imperator Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Pantinus_Imperator_stats.png)

After you kill all 6 you will complete Quest 1

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Quest1.png "Quest 1 Completed")
...
![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Phase2.png "Phase 2")

Here are the 3 stones that you are looking for

![Phase 2 1 Stones](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Phase2-1.png "Phase 2 1 Stones")

Also to note that you should not attack these. They are not necessary

![Do Not Go](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Do_not_go.png "Do Not Go")
...
<div className="player_name_bg">
  <div className="playername">Tarantula</div>
</div>
![Tarantula!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Tarantula.jpg)

![Tarantula Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Tarantula_stats.png)

You will know when you've found one by seeing the quest completion

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Quest2-1.png "Quest 2 Completed")

---

Once you find the Violet stone let's go and find the other one. Let's pick the green one as next target

![Phase 2 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Phase2-2.png "Phase 2 2")
...
<div className="player_name_bg">
  <div className="playername">Spitting Cobra</div>
</div>
![Spitting Cobra!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Spitting_Cobra.jpg)

![Spitting Cobra Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Spitting_Cobra_stats.png)

Wait for this one to find out if you have found the green stone

![Green stone found](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Quest2-2.png "Green stone found")

---

With 2 of the stones in possession, it's time to move on to the last one - the blue. Attack the Shamans

![Phase 2 3 Blue stone](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Phase2-3.png "Phase 2 3 Blue stone")
...
![Shaman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Shaman.jpg)

![Shaman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Shaman_stats.png)

When you find the blue stone from killing Shamans you should see

![Quest 3 Blue Stone Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Quest2-3.png "Quest 3 Blue Stone Completed")
...
![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Phase3.png "Boss")
...
<div className="player_name_bg">
  <div className="playername">Pyro</div>
</div>
![Pyro!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Pyro.jpg)

![Pyro Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Chamber_of_Pyro/Pyro_stats.png)
