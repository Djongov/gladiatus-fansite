...
![Phase 1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Phase1.png "Phase 1")
...
![Voodoo Warrior!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Voodoo_Warrior.jpg)

![Voodoo Warrior Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Voodoo_Warrior_stats.png)

and Quest is completed

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Quest1.png "Quest 1 Completed")

---

There is a collapsed way ahead but 2 Crocodiles are guarding it

![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Phase2.png "Phase 2")
...
![Nile Crocodile!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Nile_Crocodile.jpg)

![Nile Crocodile Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Nile_Crocodile_stats.png)

You have to kill **only one of them to bypass** the collapsed way

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Quest2.png "Quest 2 Completed")

---

You see 4 Tribal Warriors ahead and an abyss behind them. You decide to kill them and use their shields so you can cross

![Phase 3](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Phase3.png "Phase 3")
...
![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Quest3.png "Quest 3 Completed")

---

You leap through the abyss using the shields as help and you find yourself before a huge throne and the tribal leader sitting in it..

![Phase 4](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Phase4.png "Phase 4")

## Themba

<div className="player_name_bg">
  <div className="playername">Themba</div>
</div>
![Themba!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Themba.jpg)

![Themba Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Temple_of_Perdition/Themba_stats.png)

**Item Level drops: 30-37**