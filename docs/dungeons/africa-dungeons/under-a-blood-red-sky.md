...
![4/4 Warriors](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase1.png "4/4 Warriors")

## Dark Warrior

<div className="player_name_bg">
  <div className="playername">Dark Warrior</div>
</div>
![Dark Warrior!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Dark_Warrior.jpg)

![Dark Warrior Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Dark_Warrior_stats.png)

Once you kill all 4 you complete the 1st quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Quest1.png "Quest 1 Completed")
...
![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase2.png "Phase 2")
...
<div className="player_name_bg">
  <div className="playername">Lion</div>
</div>
![Lion!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Lion.jpg)

![Lion Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Lion_stats.png)

Killing the Lion completes quest 2

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Quest2.png "Quest 2 Completed")
...
![2x Elephants](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase3.png "2x Elephants")

## Pack Elephant

<div className="player_name_bg">
  <div className="playername">Pack Elephant</div>
</div>
![Pack Elephant!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Pack_Elephant.jpg)

![Pack Elephant Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Pack_Elephant_stats.png)

You complete the third quest after the Elephants

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Quest3.png "Quest 3 Completed")
...
![Animal Master](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase4.png "Animal Master")

## Animal Master

<div className="player_name_bg">
  <div className="playername">Animal Master</div>
</div>
![Animal Master!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Animal_Master.jpg)

![Animal Master Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Animal_Master_stats.png)

Killing the Animal Master completes you the 4th quest

![Quest 4 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Quest4.png "Quest 4 Completed")

---

In your pursuit you are confronted by 3 fanatic followers

![3x Fanatic Followers](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase5.png "3x Fanatic Followers")

## Fanatic

<div className="player_name_bg">
  <div className="playername">Fanatic</div>
</div>
![Fanatic!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Fanatic.jpg)

![Fanatic Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Fanatic_stats.png)

Killing the 3 followers completes the last quest but something strange is happening to Shetu this time

![Quest 5 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Quest5.png "Quest 5 Completed")

---

After Shetu's body starts to deform, two watchguard tortoises charge at you!

![2x Tortoise Watchman](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase6.png "2x Tortoise Watchman")

## Tortoise Watchman

<div className="player_name_bg">
  <div className="playername">Tortoise Watchman</div>
</div>
![Tortoise Watchman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Tortoise_Watchman.jpg)

![Tortoise Watchman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Tortoise_Watchman_stats.png)

Killing them both completes the final phase of the dungeon

![Quest 6 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Quest6.png "Quest 6 Completed")
...
![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Phase7.png "Boss")
...
<div className="player_name_bg">
  <div className="playername">Shetu bin Seth</div>
</div>
...
![Shetu bin Seth Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Under_a_Blood-Red_Sky/Shetu_bin_Seth_stats.png)
