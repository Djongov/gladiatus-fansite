...
![Poisoned Country](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Poisoned_Country.png "Poisoned Country")
...
![Mokele!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Mokele.jpg)

![Mokele Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Mokele_stats.png)

Once you have eradicated them you will complete the first quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Quest1.png "Quest 1 Completed")
...
![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Phase2.png "Phase 2")
...
![Undead Fisherman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Undead_Fisherman.jpg)

![Undead Fisherman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Undead_Fisherman_stats.png)

Once you kill 6 of them you will complete the 2nd part

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Quest2.png "Quest 2 Completed")
...
![Harbour Master Haru!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Harbour_Master_Haru.jpg)

![Harbour Master Haru Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Harbour_Master_Haru_stats.png)

Once you kill him you also complete the last quest in the dungeon

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Quest3.png "Quest 3 Completed")

---

You are ready to face the follower of the dark god Seth

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Phase4.png "Boss")

## Nithotep

<div className="player_name_bg">
  <div className="playername">Nithotep</div>
</div>
![Nithotep!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Nithotep.jpg)

![Nithotep Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Poisoned_Country/Nithotep_stats.png)
