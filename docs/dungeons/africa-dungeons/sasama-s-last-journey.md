...
![Sasama's Last journey](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Sasamas_Last_Journey.png "Sasama's Last journey")
...
![5/5 Villagers](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Phase1.png "5/5 Villagers")
...
![Villager!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Villager.jpg)

![Villager Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Villager_stats.png)

Killing the 5 villagers gives you access to the village

![Sasama's Remains](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Quest1.png "Sasama's Remains")

---

You take on the Shaman as well

![Shaman](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Phase2.png "Shaman")
...
![Shaman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Shaman.jpg)

![Shaman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Shaman_stats.png)

Killing the Shaman completes Quest 2

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Quest2.png "Quest 2 Completed")

---

By now the guards are already on alert for you so you see two warriors charging at you

![2x Voodoo Warriors](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Phase3.png "2x Voodoo Warriors")
...
![Voodoo Warrior!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Voodoo_Warrior.jpg)

![Voodoo Warrior Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Voodoo_Warrior_stats.png)

Successfully defending against these two completes the 3rd quest

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Quest3.png "Quest 3 Completed")

---

There are two guards defending the ceremony hut. You need to take them out.

![2x Spear Guards](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Phase4.png "2x Spear Guards")
...
![Spear Guard!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Spear_Guard.jpg)

![Spear Guard Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Spear_Guard_stats.png)

Defeating the 2 Spear Guards completes the last quest

![Last Quest Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Quest4.png "Last Quest Completed")
...
![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Phase5.png "Boss")

## Akhekhu

<div className="player_name_bg">
  <div className="playername">Akhekhu</div>
</div>
![Akhekhu!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Akhekhu.jpg)

![Akhekhu Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Sasamas_Last_Journey/Akhekhu_stats.png)
