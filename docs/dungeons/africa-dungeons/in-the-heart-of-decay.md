...
![In the Heart of Decay](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/In_the_Heart_of_Decay.png)
...
![Destroy the Mokele](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Phase1.png "Destroy the Mokele")
...
<div className="player_name_bg">
  <div className="playername">Mokele</div>
</div>
![Mokele!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Mokele.jpg)

![Mokele Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Mokele_stats.png)

Once you seek and destroy all the mokele you complete the first quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Quest1.png "Quest 1 Completed")
...
![4x Undead Fisherman](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Phase2.png "4x Undead Fisherman")

## Undead Fisherman

<div className="player_name_bg">
  <div className="playername">Undead Fisherman</div>
</div>
![Undead Fisherman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Undead_Fisherman.jpg)

![Undead Fisherman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Undead_Fisherman_stats.png)

Killing the fisherman completes the quest

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Quest2.png "Quest 2 Completed")

---

Unfortunately the Harbour Master has been infected as well turning him into a formidable monster

![Infected Harbour Master](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Phase3.png "Infected Harbour Master")
...
<div className="player_name_bg">
  <div className="playername">Harbour Master Haru</div>
</div>
![Harbour Master Haru!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Harbour_Master_Haru.jpg)

![Harbour Master Haru Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Harbour_Master_Haru_stats.png)

You take your knife out of the creature's body and you hear a strange chanting

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Quest3.png "Quest 3 Completed")
...
![Chanting heard](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Phase4.png "Chanting heard")

## Seth Priest

<div className="player_name_bg">
  <div className="playername">Seth Priest</div>
</div>
![Seth Priest!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Seth_Priest.jpg)

![Seth Priest Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Seth_Priest_stats.png)

Killing all 5 completes the final quest in the dungeon

![Final Quest Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Quest4.png "Final Quest Completed")
...
![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Phase5.png "Boss")
...
<div className="player_name_bg">
  <div className="playername">Corruption</div>
</div>
![Corruption!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Corruption.jpg)

![Corruption Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/In_the_Heart_of_Decay/Corruption_stats.png)
...
Also, Corruption will heal for 50% of the damage she does in the attack -
    ...
    Corruption hits Elite Spear Carrier. Elite Spear Carrier receives 2609 damage   Corruption delights in her victim`s pain Corruption receives 1304 healing   **Round 4, 21, 36 or every 15 rounds : A tentacle shoots out of the ground and wraps itself around \{random NPC\}. He will need 3 rounds to liberate himself from its grasp.**
