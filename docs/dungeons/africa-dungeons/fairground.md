...
![Fairground](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Fairground.png "Fairground")
...
![Phase1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Phase1.png "Phase1")

## Villager

<div className="player_name_bg">
  <div className="playername">Villager</div>
</div>
![Villager!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Villager.jpg)

![Villager Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Villager_stats.png)

You kill all 5 and manage to get through

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Quest1.png "Quest 1 Completed")

---

Now that the crowd is gone, time to pick on the individual elements. Take off the shaman.

![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Phase2.png "Phase 2")

## Shaman

<div className="player_name_bg">
  <div className="playername">Shaman</div>
</div>
![Shaman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Shaman.jpg)

![Shaman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Shaman_stats.png)

Also completes the 2nd quest in the game

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Quest2.png "Quest 2 Completed")

---

Your quick slicing through your enemies have alerted some of the royal guards of the village. They attack you.

![Phase 3](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Phase3.png "Phase 3")

## Voodoo Warrior

<div className="player_name_bg">
  <div className="playername">Voodoo Warrior</div>
</div>
![Voodoo Warrior!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Voodoo_Warrior.jpg)

![Voodoo Warrior Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Voodoo_Warrior_stats.png)

Killing both of them rewards you the third question completion

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Quest3.png "Quest 3 Completed")

---

A huge crocodile attacks. Looks like the boss' pet

![Phase 4](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Phase4.png "Phase 4")

## Nile Crocodile

<div className="player_name_bg">
  <div className="playername">Nile Crocodile</div>
</div>
![Nile Crocodile!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Nile_Crocodile.jpg)

![Nile Crocodile Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Nile_Crocodile_stats.png)

![Quest 4 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Quest4.png "Quest 4 Completed")
...
![Phase 5](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Phase5.png "Phase 5")

## Spear Guard

<div className="player_name_bg">
  <div className="playername">Spear Guard</div>
</div>
![Spear Guard!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Spear_Guard.jpg)

![Spear Guard Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Spear_Guard_stats.png)

Killing both of them completes the final quest in this long dungeon. Papa Sasama is exposed!

![Quest 5 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Quest5.png "Quest 5 Completed")

---

You have exposed the tribal leader Papa Sasama. He is alone! Time to attack

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Phase6.png "Boss")

## Papa Sasama

<div className="player_name_bg">
  <div className="playername">Papa Sasama</div>
</div>
![Papa Sasama!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Papa_Sasama.jpg)

![Papa Sasama Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Africa/Fairground/Papa_Sasama_stats.png)
