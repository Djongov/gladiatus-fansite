...
![Externsteine](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Externsteine.png "Externsteine")
...
![Fanatics](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Fanatics-No.png "Fanatics")

Go for Tree Shepherd

![Tree Shepherd](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Tree-Shepherd-Yes.png "Tree Shepherd")

## Tree Shepherd

<div className="player_name_bg">
  <div className="playername">Tree Shepherd</div>
</div>

![Tree Shepherd!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Tree_Shepherd.jpg)

![Tree Shepherd Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Tree_Shepherd_stats.png)

and you complete the first quest!

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Quest1_Completed.png "Quest 1 Completed")
...
![Externsteine](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Externsteine-phase2.png "Externsteine")

## Druidic Priest

<div className="player_name_bg">
  <div className="playername">Druidic Priest</div>
</div>

![Druidic Priest!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Druidic_Priest.jpg)

![Druidic Priest Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Druidic_Priest_stats.png)
...
![Dragon Maiden](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Externsteine-phase3.png "Dragon Maiden")

## Dragon Maiden

<div className="player_name_bg">
  <div className="playername">Dragon Maiden</div>
</div>

![Dragon Maiden!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Dragon_Maiden.jpg)

![Dragon Maiden Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Dragon_Maiden_stats.png)

Killing her completes the final quest "Hit back against the surprise attack" and you are ready to face the fearsome boss

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Quest3_Completed.png "Quest 3 Completed")

---

The boss is a huge dragon

![Extersteine Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Externsteine-phase4.png "Extersteine Boss")
...
<div className="player_name_bg">
  <div className="playername">Wrath Mountain</div>
</div>

![Wrath Mountain!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Wrath_Mountain.jpg)

![Wrath Mountain Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Externsteine/Wrath_Mountain_stats.png)
