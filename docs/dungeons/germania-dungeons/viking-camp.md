...
![Viking Camp](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Camp.png "Viking Camp")
...
![Phase 1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Camp_phase1.png "Phase 1")

## Fearless Viking

<div className="player_name_bg">
  <div className="playername">Fearless Viking</div>
</div>

![Fearless Viking!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Fearless_Viking.jpg)

![Fearless Viking Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Fearless_Viking_stats.png)

Once you cut through all of them you complete the first quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Task1.png "Quest 1 Completed")

---

Continuing down the camp seems to quiet. You spot an ambush. You decide to attack first.

![Ambush](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Camp_phase2.png "Ambush")
...
<div className="player_name_bg">
  <div className="playername">Deukalionit</div>
</div>

![Deukalionit!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Deukalionit.jpg)

![Deukalionit Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Deukalionit_stats.png)

Once you kill both you will complete the second quest

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Task2.png "Quest 2 Completed")

---

You seem to be ready to confront the Viking chief and see what is that horn behind him

![Viking Chief](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Camp_phase3.png "Viking Chief")
...
<div className="player_name_bg">
  <div className="playername">Viking Chief</div>
</div>

![Viking Chief!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Chief.jpg)

![Viking Chief Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Chief_stats.png)

and you blow the horn behind him and complete the last quest

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Task3.png "Quest 3 Completed")

---

Unfortunately blowing the horn awakens a creature that comes from the swamp and stands right in front of you.

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Viking_Camp_phase4.png "Boss")

## Homo Nautilus

<div className="player_name_bg">
  <div className="playername">Homo Nautilus</div>
</div>

![Homo Nautilus!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Homo_Nautilus.jpg)

![Homo Nautilus Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/Viking_Camp/Homo_Nautilus_stats.png)
