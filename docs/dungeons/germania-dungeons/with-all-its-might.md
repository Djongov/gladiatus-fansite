...
![With all its might](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/With_all_its_might.png "With all its might")
...
![Fanatic!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Fanatic.jpg)

![Fanatic Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Fanatic_stats.png)
...
<div className="player_name_bg">
  <div className="playername">Stone Guard</div>
</div>

![Stone Guard!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Stone_Guard.jpg)

![Stone Guard Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Stone_Guard_stats.png)

At some point you will complete the Quest 1. You might not have to kill all Stone Guards

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Quest1_completed.png "Quest 1 Completed")

You will know this when the 3 Druids become available for attack

![Phase 3](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/With_all_its_might_phase3.png "Phase 3")
...
![Druidic Priest!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Druidic_Priest.jpg)

![Druidic Priest Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Druidic_Priest_stats.png)

Once the druids are done you managed to save the girl from being sacrificed.

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Quest2_completed.png "Quest 2 Completed")

---

You have the boss in front. A huge green dragon on the top of the mountain.

![Phase 4](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/With_all_its_might_phase4.png "Phase 4")
...
<div className="player_name_bg">
  <div className="playername">Oak Lord</div>
</div>

![Oak Lord!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Oak_Lord.jpg)

![Oak Lord Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Germania/With_all_its_might/Oak_Lord_stats.png)
