---
title: War Against The Numidians
slug: /events/war-against-the-numidians
redirects:
...
![War against the Numidians](https://gladiatusfansite.blob.core.windows.net/images/Events/War_Against_The_Numidians/War_against_the_Numidians_banner.jpg "War against the Numidians")

![War against the Numidians](https://gladiatusfansite.blob.core.windows.net/images/Events/War_Against_The_Numidians/War_against_the_Numidians_description.png "War against the Numidians")
...
**Total**  ![Most points in the entire event](https://gladiatusfansite.blob.core.windows.net/images/Events/reward_gold.png "Most points in the entire event") - Most points in the entire event - Title: **Champion of Africa**
...
Because the event is a wave-based expedition, at first you will only have Opponent 1 available to fight. He is the first wave. After defeating Opponent 1 X amount of times, Opponent 1 becomes inactive and Opponent 2 becomes available. Wave 2. Again after X amount of kills on Opponent 2, it deactivates and Wave 3 comes with Opponent 3 being available. After X amount of kills on Opponent 3 the boss comes who is Opponent 4. Unlike the rest, the boss is a single kill but with large health pool. When the health of the boss drops to 0 the boss is defeated and the entire event is completed. All the rewards then are distributed as packages/buffs/titles.
...
![Militiaman](https://gladiatusfansite.blob.core.windows.net/images/Events/War_Against_The_Numidians/Militiaman.jpg)
...
![Event end](https://gladiatusfansite.blob.core.windows.net/images/Events/reconstruction-end.png "Event end")