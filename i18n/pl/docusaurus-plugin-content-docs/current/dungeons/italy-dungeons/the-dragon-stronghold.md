...
![2/2 Cerberus](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Cerberus_phase.png "2/2 Cerberus")
...
![Cerberus!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Cerberus.jpg)

![Cerberus Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Cerberus_stats.png)

Once you kill both of them you will complete the first quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Quest1_Completed.png "Quest 1 Completed")

---

There is a pitfall trap ahead. You have to disarm it. Kill the divers.

![3/3 Undersea Diver](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Pitfall_Trap.png "3/3 Undersea Diver")

## Undersea Diver

<div className="player_name_bg">
  <div className="playername">Undersea Diver</div>
</div>
![Undersea Diver!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Undersea_Diver.jpg)

![Undersea Diver Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Undersea_Diver_stats.png)

You kill all 3 and pull the level

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Quest2_Completed.png "Quest 2 Completed")

---

Now you have to face Barakun

![1/1 Barakun](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/The_Dragon_Stronghold_phase2.png "1/1 Barakun")

## Barakun

<div className="player_name_bg">
  <div className="playername">Barakun</div>
</div>
![Barakun!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Barakun.jpg)

![Barakun Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Barakun_stats.png)

Defeating him completes the 3rd and final quest. You are ready to face the boss now.

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/Quest3_Completed.png "Quest 3 Completed")

---

The boss is a Dragon guarding a treasure!

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Dragon_Stronghold/The_Dragon_Stronghold_phase3.png "Boss")

## Oribas

<div className="player_name_bg">
  <div className="playername">Oribas</div>
</div>
