...
![The Last Resort](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/The_Last_Resort.png "The Last Resort")

## Quests

1. The senator has disguised himself and is trying to get to the pier undetected. Fight your way past the traitor`s followers who want to stop you

---

First, you need to defeat 3 pairs of 2 Gnaeus` Follower

![Phase 1](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Phase1.png "Phase 1")

## Gnaeus Follower

<div className="player_name_bg">
  <div className="playername">Gnaeus Follower</div>
</div>
![Gnaeus Follower!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Gnaeus_Follower.jpg)

![Gnaeus Follower Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Gnaeus_Follower_stats.png)

Once you kill all 6 of them you will complete first step

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Quest1.png "Quest 1 Completed")

---

You see 6 Suspicious Fisherman approaching you. Seems like they want to fight

![Phase 2](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Phase2.png "Phase 2")

## Suspicious Fisherman

<div className="player_name_bg">
  <div className="playername">Suspicious Fisherman</div>
</div>
![Suspicious Fisherman!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Suspicious_Fisherman.jpg)

![Suspicious Fisherman Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Suspicious_Fisherman_stats.png)

Killing all of them rewards the 2nd quest completion

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Quest2.png "Quest 2 Completed")
...
![Gnaeus](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Phase3.png "Gnaeus")

## Gnaeus Aurelius Flavio

<div className="player_name_bg">
  <div className="playername">Gnaeus Aurelius Flavio</div>
</div>
![Gnaeus Aurelius Flavio!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Gnaeus_Aurelius_Flavio.jpg)

![Gnaeus Aurelius Flavio Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Gnaeus_Aurelius_Flavio_stats.png)

Killing Gnaeus isn't the end! There is someone else behind the whole smuggling operation!

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Quest3.png "Quest 3 Completed")
...
![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Phase4.png "Boss")

## Captain Kratos

<div className="player_name_bg">
  <div className="playername">Captain Kratos</div>
</div>
![Captain Kratos!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Captain_Kratos.jpg)

![Captain Kratos Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/The_Last_Resort/Captain_Kratos_stats.png)
