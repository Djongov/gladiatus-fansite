...
![Zagrash's Fort](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Zagrashs_Fort.png "Zagrash's Fort")
...
![2x Gate Guards](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Phase1.png "2x Gate Guards")

## Gate Guards

<div className="player_name_bg">
  <div className="playername">Gate Guards</div>
</div>
![Gate Guards!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Gate_Guards.jpg)

![Gate Guards Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Gate_Guards_stats.png)

Killing both of them completes the first quest

![Quest 1 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Quest1.png "Quest 1 Completed")
...
![2x Patrol](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Phase2.png "2x Patrol")

## Patrol

<div className="player_name_bg">
  <div className="playername">Patrol</div>
</div>
![Patrol!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Patrol.jpg)

![Patrol Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Patrol_stats.png)

Killing both guards you find a key

![Quest 2 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Quest2.png "Quest 2 Completed")
...
![8x Medusas](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Phase3.png "8x Medusas")

## Medusa

<div className="player_name_bg">
  <div className="playername">Medusa</div>
</div>
![Medusa!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Medusa.jpg)

![Medusa Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Medusa_stats.png)

One tower down...

![One Tower Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/One_Down.png "One Tower Down")

Two towers down...

![Two Towers Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Two_Down.png "Two Towers Down")

Three towers down...

![Three Towers Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Three_Down.png "Three Towers Down")

And the last tower is down...

![Four Towers Down](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Four_Down.png "Four Towers Down")

![Quest 3 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Quest3.png "Quest 3 Completed")
...
![2x Battle Druid](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Phase4.png "2x Battle Druid")

## Battle Druid

<div className="player_name_bg">
  <div className="playername">Battle Druid</div>
</div>
![Battle Druid!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Battle_Druid.jpg)

![Battle Druid Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Battle_Druid_stats.png)

Killing them both ensures the safety of the villagers

![Quest 4 Completed](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Quest4.png "Quest 4 Completed")

---

Now that the villagers are safe and all the fort is executed by your own hand, it's time to face the Fort master - Zagrash

![Boss](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Phase5.png "Boss")
...
<div className="player_name_bg">
  <div className="playername">Zagrash</div>
</div>
![Zagrash!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Zagrash.jpg)

![Zagrash Stats!](https://gladiatusfansite.blob.core.windows.net/images/Dungeons/Italy/Zagrashs_Fort/Zagrash_stats.png)
